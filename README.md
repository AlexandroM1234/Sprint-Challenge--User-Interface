...
Its code that defines what content is on a webpage

2. Name two big differences between ```display: block;``` and ```display: inline;```.

inline block allows to set a width and height on an element and top and bottom margins/paddings are respectd but with inline they aren't
...
So developers can go back to old code incase they broke new code and can't figure out the problem
